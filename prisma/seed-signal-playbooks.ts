...
const TEMPLATES: TemplateDef[] = [
  ...
  // ── 1. New C-Suite Executive ───────────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'ENGINEERING', 'FINANCE', 'OPERATIONS'],
  ...
  // ── 2. New VP-Level Hire ───────────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'ENGINEERING', 'SALES', 'MARKETING', 'OPERATIONS', 'FINANCE'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
  ...
  // ── 3. Multiple Department Heads Hired ─────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'ENGINEERING', 'SALES', 'MARKETING', 'OPERATIONS', 'FINANCE', 'IT_DATA_CENTER'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
  ...
  // ── 4. Executive Departure ─────────────────────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'ENGINEERING', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
  ...
  // ── 5. Founder Stepping Down ───────────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP'],
  ...
  // ── 6. Layoffs/Headcount Reduction ─────────────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'OPERATIONS', 'IT_DATA_CENTER'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
  ...
  // ── 7. Rapid Hiring Surge ──────────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['SALES', 'ENGINEERING', 'OPERATIONS', 'MARKETING', 'IT_DATA_CENTER'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
  ...
  // ── 8. Engineering Team Expansion ──────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['ENGINEERING', 'IT_DATA_CENTER'],
  ...
  // ── 9. Sales Team Expansion ────────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['SALES', 'EXECUTIVE'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director', 'Manager'],
    timingConfig: { validWindowDays: 14, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 10. Geographic Expansion ───────────────────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['EXECUTIVE', 'OPERATIONS', 'SALES', 'MARKETING'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
  ...
  // ── 11. Job Posting for Your Category ──────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['ENGINEERING', 'SALES', 'MARKETING', 'OPERATIONS', 'IT_DATA_CENTER'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
  ...
  // ── 12. Series A/Seed Funding ──────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'ENGINEERING'],
  ...
  // ── 13. Series B Funding ───────────────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'ENGINEERING', 'SALES', 'FINANCE'],
  ...
  // ── 14. Series C+ / Late-Stage Funding ─────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'FINANCE', 'ENGINEERING'],
  ...
  // ── 15. Quarterly Earnings Beat ────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'SALES', 'MARKETING'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP'],
  ...
  // ── 16. Quarterly Earnings Miss ────────────────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'SALES', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director'],
    timingConfig: { validWindowDays: 28, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 18. IPO Announcement ───────────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'IT_DATA_CENTER'],
    targetIndustries: ['Technology', 'Healthcare', 'Finance', 'Manufacturing'],
    targetPersonas: ['C-Suite', 'VP', 'Director'],
    timingConfig: { validWindowDays: 30, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 20. Acquisition (They Acquired) ────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'OPERATIONS', 'FINANCE'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director'],
  ...
  // ── 24. Strategic Partnership Announcement ─────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['EXECUTIVE', 'MARKETING', 'SALES'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director'],
    timingConfig: { validWindowDays: 14, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 25. Technology Partnership/Integration ─────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['ENGINEERING', 'IT_DATA_CENTER', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing'],
    targetPersonas: ['VP', 'Director', 'Manager'],
    timingConfig: { validWindowDays: 30, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 26. New Technology Adoption ────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['IT_DATA_CENTER', 'ENGINEERING', 'OPERATIONS'],
  ...
  // ── 28. Legacy System Sunset ───────────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['IT_DATA_CENTER', 'ENGINEERING', 'OPERATIONS', 'EXECUTIVE'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
  ...
  // ── 29. Product Launch Announcement ────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['MARKETING', 'ENGINEERING', 'SALES', 'EXECUTIVE'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
    timingConfig: { validWindowDays: 28, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 30. Security Breach/Incident ───────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['IT_DATA_CENTER', 'EXECUTIVE', 'ENGINEERING'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director'],
    timingConfig: { validWindowDays: 7, triggerDaysBefore: 0, urgencyDecay: 'step' },
    expectedOutcome:
  ...
  // ── 31. Compliance Certification Pursued ───────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['IT_DATA_CENTER', 'EXECUTIVE', 'FINANCE'],
    targetIndustries: ['Technology', 'Healthcare', 'Finance', 'Manufacturing'],
    targetPersonas: ['VP', 'Director', 'Manager'],
    timingConfig: { validWindowDays: 180, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 32. Tech Stack Changes Detected ────────────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['IT_DATA_CENTER', 'ENGINEERING', 'MARKETING', 'SALES', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
    timingConfig: { validWindowDays: 28, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 33. Analyst Recognition ────────────────────────────────────────────────
  {
    ...
    priority: 5,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'ENGINEERING'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director'],
    timingConfig: { validWindowDays: 14, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 36. Contract Renewal Window ────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'FINANCE', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
  ...
  // ── 37. Public Vendor Complaints ───────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['IT_DATA_CENTER', 'ENGINEERING', 'OPERATIONS', 'SALES', 'MARKETING'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
  ...
  // ── 38. Competitor Acquisition ─────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director'],
    timingConfig: { validWindowDays: 30, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 39. Pricing Page Visits ────────────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'IT_DATA_CENTER', 'ENGINEERING', 'SALES', 'MARKETING'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director', 'Manager'],
  ...
  // ── 40. Demo Request/Trial Signup ──────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'ENGINEERING', 'SALES', 'MARKETING', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager', 'Individual Contributor'],
    timingConfig: { validWindowDays: 1, triggerDaysBefore: 0, urgencyDecay: 'step' },
    expectedOutcome:
  ...
  // ── 41. Case Study Downloads ───────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['EXECUTIVE', 'IT_DATA_CENTER', 'ENGINEERING', 'SALES', 'MARKETING'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
    timingConfig: { validWindowDays: 1, triggerDaysBefore: 0, urgencyDecay: 'step' },
    expectedOutcome:
  ...
  // ── 48. Usage Spike/Seat Growth ────────────────────────────────────────────
  {
    ...
    priority: 8,
    targetDepartmentTypes: ['IT_DATA_CENTER', 'ENGINEERING', 'SALES', 'MARKETING', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['VP', 'Director', 'Manager'],
    timingConfig: { validWindowDays: 14, triggerDaysBefore: 0, urgencyDecay: 'linear' },
    expectedOutcome:
  ...
  // ── 51. Customer Raised Funding ────────────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'ENGINEERING', 'SALES'],
  ...
  // ── 53. Contract Renewal Approaching ───────────────────────────────────────
  {
    ...
    priority: 10,
    targetDepartmentTypes: ['EXECUTIVE', 'FINANCE', 'IT_DATA_CENTER', 'OPERATIONS'],
    targetIndustries: ['Automotive', 'Technology', 'Manufacturing', 'Healthcare', 'Finance', 'Retail'],
    targetPersonas: ['C-Suite', 'VP', 'Director'],
