  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <section className="rounded-lg border border-gray-200 bg-gray-50/50 p-4">
        ...
        <p className="text-sm text-gray-600">If competitor mention detected: send battlecard (e.g. your company vs competitor). Talking points from your company data.</p>
        <div className="flex gap-2 mt-2">
