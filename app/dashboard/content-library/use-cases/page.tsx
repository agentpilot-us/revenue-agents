...
export default async function UseCasesPage() {
  ...
  const useCases = await prisma.contentLibrary.findMany({
    where: {
      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Industry-specific use cases that match the problems you solve
          </p>
        </div>
        <div className="flex gap-3 flex-shrink-0">
          <Link href="/dashboard/content-library/import?type=UseCase">
      ...
      {useCases.length === 0 ? (
        <div className="border-2 border-dashed border-gray-300 dark:border-zinc-700 rounded-xl p-10 bg-white dark:bg-zinc-800 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-lg mx-auto">
            Add use cases that match the industries you sell to. Import from URL or add manually.
          </p>
