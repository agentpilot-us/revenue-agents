  ...
  return (
    <div className="p-8 max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl font-bold mb-2 text-gray-900 dark:text-gray-100">
        Upload product descriptions & pricing
      </h1>
      <p className="text-gray-600 dark:text-gray-400 mb-6">
        Upload a CSV file with columns: <strong>name</strong> (required), description, priceMin, priceMax, pricingModel, category.
      </p>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div>
          ...
          <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
            Example: name, description, priceMin, priceMax, pricingModel, category
          </p>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <Link href="/dashboard/content-library?tab=products">
            <button type="button" className="px-6 py-3 border border-gray-300 dark:border-zinc-600 rounded hover:bg-gray-50 dark:hover:bg-zinc-800 text-gray-700 dark:text-gray-200">
              Cancel
            </button>
          </Link>
        </div>
          ...
          {result.success ? (
            <>
              <p className="font-medium text-green-800 dark:text-green-200">
                Created {result.created ?? 0} product(s).
              </p>
