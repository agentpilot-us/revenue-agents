      ...
      <div className="flex justify-between items-start mb-6">
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">
            Company events, webinars, and conferences to recommend in outreach
          </p>
        </div>
        <div className="flex gap-3 flex-shrink-0">
          <Link href="/dashboard/content-library/sync-nvidia">
            <button className="px-4 py-2 border border-purple-600 dark:border-purple-400 text-purple-600 dark:text-purple-400 rounded hover:bg-purple-50 dark:hover:bg-purple-900/20">
              Scrape site (GTC/events)
            </button>
          </Link>
          <Link href="/dashboard/content-library/events/add">
      ...
      {events.length === 0 ? (
        <div className="border-2 border-dashed border-gray-300 dark:border-zinc-700 rounded-xl p-10 bg-white dark:bg-zinc-800 text-center">
          ...
          <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-lg mx-auto">
            Add events with a name and URL for details/sessions, or scrape GTC/other event sites.
          </p>
