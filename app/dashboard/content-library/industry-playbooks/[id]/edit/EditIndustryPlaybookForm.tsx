...
export function EditIndustryPlaybookForm({
  playbookId,
  initialName,
  initialOverview,
}: Props) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setMessage(null);
    try {
      const res = await fetch(`/api/industry-playbooks/${playbookId}`, {
        method: 'PUT',
      ...
      setMessage({ type: 'success', text: 'Industry playbook updated. Redirecting...' });
