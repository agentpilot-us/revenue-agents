...
-- Run this in Neon SQL Editor to sync your database with Prisma schema
...
-- Create User table (with subscription fields)
CREATE TABLE "User" (
    "id" TEXT NOT NULL,
    "name" TEXT,
    "email" TEXT NOT NULL,
...
-- Verify the User table has subscriptionId column
SELECT column_name, data_type 
FROM information_schema.columns 
WHERE table_name = 'User' AND column_name IN ('subscriptionId', 'subscriptionStatus', 'subscriptionTier')
